...
// 		},
	...
	$(document).on('click', function(event) {
		// Перевірити, чи клік був на елементі з класом vi-menu-nav__item
		if (!$(event.target).closest('.vi-menu-nav__item').length) {
			// Зняти клас з усіх елементів
			$('.vi-menu-nav__item').removeClass('vi-menu-nav__item--active');
		}
	});
		 //  Клик по елементу  vi-goods-card__gift-choose
		 $('.vi-menu-nav__item').on('click', function() {
			// Убить клас vi-goods-card__gift-choose--picked со всех
			$('.vi-menu-nav__item').removeClass('vi-menu-nav__item--active');
			
			// Добавить клас vi-goods-card__gift-choose--picked текущему елементу
			$(this).addClass('vi-menu-nav__item--active');
		});
		...
		$('.vi-gamburger').on('click', function() {
			
			$('body').addClass('vi-gamburger-active');
		});
		$('.vi-menu-nav__close').on('click', function() {
			
			$('body').removeClass('vi-gamburger-active');
		});
	...
	$("#search").on("input", function () {
		if ($(this).val().trim() !== "") {
			$(".vi-menu__lupa").hide();
			$(".vi-menu__close-search").show();
		} else {
			$(".vi-menu__lupa").show();
			$(".vi-menu__close-search").hide();
		}
	});
	// Клик  по крестику при вводе в поиске сбрасивает до начального состояния, 
	$(".vi-menu__close-search").on("click", function () {
		$("#search").val("");
		$(this).hide();
		$(".vi-menu__lupa").show();
